...
POST /albums?id=13&title=Reputation&release_year=2017&artist_id=3
...
POST /albums?id=14&title=Head_Carrier&release_year=2016&artist_id=1
...
describe Application do
  ...
  context "POST /albums" do
    ...
    it 'returns 404 Not Found' do
      response = get('/albums?id=13&title=Reputation&release_year=2017&artist_id=10')
